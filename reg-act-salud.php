...
$sql = "SELECT IdActividadesSalud, NombreActividadSalud FROM actividadessalud";
...
<head>
  ...
  <title>Registar Actividad de Salud</title>
...
<form id="regForm" action="actions/reg-act-salud.php" method="POST">
  <div class="tab container bg-white p-5 mt-5">
    <h1 style="text-align: center; color:darkblue;">Actividad de Salud por Participante</h1>
      <div class="form-row centrar">
        ...
        <div class="form-group col-md-10">
          ...
          <select class="form-control" id="ActividadSalud" name="ActividadSalud" required>
