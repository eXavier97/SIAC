...
$sql = "SELECT IdActividadEdu, NombreActividaEdu FROM actividadeseducativas";
...
<head>
  ...
  <title>Registar Actividad Educativa</title>
...
<form id="regForm" action="actions/reg-act-edu.php" method="POST">
  <div class="tab container bg-white p-5 mt-5">
    <h1 style="text-align: center; color:darkblue;">Actividad Educativa por Participante</h1>
      <div class="form-row centrar">
        ...
        <div class="form-group col-md-10">
          ...
          <select class="form-control" id="ActividadEducativa" name="ActividadEducativa" required>
